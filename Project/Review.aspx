<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Review.aspx.cs" Inherits="Project.Review" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                   <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered zero-configuration" runat="server"></asp:GridView>
                                </div>
                            </div>
                        </div>
                    </div>
