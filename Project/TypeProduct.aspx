<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeProduct.aspx.cs" Inherits="Project.TypeProduct" %>
           ...
           <div class="row">
                              <div class="clearfix hidden-md-up"></div>
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <asp:DataList ID="Repeater1" runat="server" RepeatColumns="4" BackColor="#ffffcc" BorderWidth="2px" BorderStyle="Groove" DataSourceID="SqlDataSource1" DataKeyField="Pid">
                                        <itemtemplate>
                           ...
                           <asp:Label ID="pstatus" runat="server" Text='<%# Eval("Status") %>' ForeColor="#000000" Class="lblproduct"></asp:Label>--%>
                                    ...
                                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Database1ConnectionString %>' SelectCommand="SELECT [Image1], [Pid] FROM [tbl_Product] WHERE ([Tid] = @Tid)">
                                        <SelectParameters>
                                            <asp:SessionParameter SessionField="Male" Name="Tid" Type="Int32"></asp:SessionParameter>
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </div>
                            </div>
