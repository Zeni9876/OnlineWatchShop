<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProductDetails.aspx.cs" Inherits="Project.EditProductDetails" %>
        ...
        <div class="container-xl px-4 mt-4">   
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                       <h1><div class="card-header">Product Details</div></h1> 
                        <div class="card-body">
                ...
                <table>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="txtCat" runat="server"></asp:TextBox></td>
                    </tr>
                     <tr>
                        <td>Product Brand:</td>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="txtQuant" runat="server"></asp:TextBox></td>
                    </tr>
                     <tr>
                     ...
                     <tr>
                <td colspan="2"><asp:Button ID="btnUpdate" runat="server" Text="Save Changes" OnClick="btnUpdate_Click" /></td>
