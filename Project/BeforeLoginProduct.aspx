<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeforeLoginProduct.aspx.cs" Inherits="Project.BeforeLoginProduct" %>
                    ...
                    <div class="row">
                        ...
                        <div class="clearfix hidden-md-up"></div>
                           ...
                           <asp:Label ID="pstatus" runat="server" Text='<%# Eval("Status") %>' ForeColor="#000000" Class="lblproduct"></asp:Label>--%>
                                        <asp:LinkButton ID="LinkButton1" Class="btn" runat="server" BackColor="#ff5050" ForeColor="#ffffff" PostBackUrl='<%# "Addtocart.aspx?Pid=" + Eval("Pid") %>' OnClick="LinkButton1_Click">Add To Cart</asp:LinkButton>
                                        &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;
                                    </itemtemplate>
