<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfterLoginHome.aspx.cs" Inherits="Project.AfterLoginHome" %>
      ...
      <div class="container-fluid">
          ...
          <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              <img src="watch1.jpg" style="width: 1000px;">
              <div class="text">Caption Text</div>
            </div>
            
            <div class="mySlides fade">
              <img src="watch2.jpg" style="width:1000px;">
              <div class="text">Caption Two</div>
            </div>
            
            <div class="mySlides fade">
              <img src="watch3.jpg" style="width:1000px">
           ...
           <p>
            <img src="watch4.jpg" alt="Smiley face" style="float:right;border-radius: 2px;margin: 2px;width:33%;height:45%;">
            <img src="watch5.jpg" alt="Smiley face" style="float:center;border-radius: 2px;width:33%;height:45%;">
            <img src="watch3.jpg" alt="Smiley face" style="float:left;border-radius: 2px;margin: 2px;width:33%;height:30%;">
            </p>

        <asp:DataList ID="review" runat="server">
            <ItemTemplate>
                <table>
                    <tr>
