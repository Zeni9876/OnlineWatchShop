<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="COD.aspx.cs" Inherits="Project.COD" %>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
        ...
        <a href="AfterLoginHome.aspx" class="nav-link">Go to Home</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Info boxes -->
        <center><h1 style="align-content:center">Total Amount</h1>
          <h3><% Response.Write(Session["Totalamountcu"]); %></h3></center> 
      </div><!--/. container-fluid -->
    </section>
    <!-- /.content -->
  </div>
